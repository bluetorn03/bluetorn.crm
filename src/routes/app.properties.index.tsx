...
import { listProperties, qk } from "@/lib/crm-api";
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              {rows.map((p) => (
                <Link
                  ...
                  className="bg-card border-border elev-1 hover:elev-2 group overflow-hidden rounded-xl border transition-shadow"
                >
                  {p.image_url ? (
